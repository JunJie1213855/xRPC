...
void ZkClient::Start()
{
    ...
    std::string host = XrpcApplication::GetInstance().GetConfig().Load("zookeeperip");
    std::string port = XrpcApplication::GetInstance().GetConfig().Load("zookeeperport");
    ...
    */
    ...
    // zookeeper_init 成功 -> global_watcher -> 设置 is_connected
